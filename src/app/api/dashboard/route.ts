  ...
  try {
    ...
    for (const expense of currentMonthExpenses) {
      ...
      currentByCategory.set(
        category,
        (currentByCategory.get(category) ??
          0) + amount
      );
    }
